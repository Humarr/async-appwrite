...
class Tokens(AsyncService):
    ...
    async def list(
        ...
        return await self.client.call("get", api_path, {}, api_params)

    async def create_file_token(
        self, bucket_id: str, file_id: str, expire: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def get(self, token_id: str) -> Dict[str, Any]:
        """
    ...
    async def update(
        self, token_id: str, expire: Optional[str] = None
    ) -> Dict[str, Any]:
        """
